						...
						<div class="tp_recent_tweets">
							...
							foreach($tp_twitter_plugin_tweets as $tweet){
								if(!empty($tweet['text'])){
									...
									print '<li><i class="kt-icon-twitter2 " style="font-size:14px; display=inline-block; color:#ffffff;"></i><a style="display=inline-block;" class="twitter_time" target="_blank" href="http://twitter.com/'.$instance['username'].'/statuses/'.$tweet['status_id'].'">'.tp_relative_time($tweet['created_at']).'</a><span>'.tp_convert_links($tweet['text']).'</span></li>';
