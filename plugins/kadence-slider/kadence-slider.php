...
function kadence_slider_scripts() {
  wp_enqueue_style('kadence_slider_css', KADENCE_SLIDER_URL . 'css/kad-slider.css', false, '150');
  wp_register_script('kadence_slider_js', KADENCE_SLIDER_URL . 'js/min/kadence-slider-min.js', false, 150, true);
