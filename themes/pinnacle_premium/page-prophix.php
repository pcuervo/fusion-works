	...
	<section class="[ container ]">
		<article class="[ row ]">
			<div class="[ col-xs-6 col-sm-6 ][ hidden-xs ]">
				<img class="[ wow bounceInRight ][ img-responsive img-centered ]" src="<?php echo THEMEPATH; ?>assets/img/prophix-map.png" alt="">
			</div>
			<div class="[ col-xs-6 col-sm-6 ][ text-center-xs ]">
			...
			<div class="[ col-xs-12 col-sm-6 ][ visible-xs ]">
				<img class="[ wow bounceInRight ][ img-responsive img-centered ]" src="<?php echo THEMEPATH; ?>assets/img/prophix-map.png" alt="Prophix Map">
			</div>
		</article>
	</section> <!-- /section -->

	<section class="[ background-secondary ][ padding-top ]">
		<div class="[ container ]">
			<div class="[ row ]">
				...
				<div class="[ col-ss-12 col-sm-6 ][ padding ][ text-center ]">
					<img class="[ img-responsive img-centered ][ wow zoomIn ]" src="<?php echo THEMEPATH; ?>assets/img/implementatios.png" alt="">
				</div>
			</div>
		</div>
		<div class="[ row ]">
			<div class="[ col-ss-12 col-sm-4 ]">
				<img class="[ width-100 img-centered ][ wow bounceInUp ]" src="<?php echo THEMEPATH; ?>assets/img/cogs.png" alt="cogs">
			</div>
			<div class="[ col-ss-12 col-sm-4 ][ hidden-xs ]">
				<img class="[ width-100 img-centered ][ wow bounceInUp ]" src="<?php echo THEMEPATH; ?>assets/img/cogs.png" alt="cogs">
			</div>
			<div class="[ col-ss-12 col-sm-4 ][ hidden-xs ]">
				<img class="[ width-100 img-centered ][ wow bounceInUp ]" src="<?php echo THEMEPATH; ?>assets/img/cogs.png" alt="cogs">
	...
	<section class="[ background-quaternary ][ padding ]">
		<article class="[ container ]">
			...
			<div class="[ row ][ margin-bottom--xlarge ]">
				...
				<div class="[ col-sm-4 ]">
					<img class="[ width-100 img-centered ][ wow bounceInUp ]" src="<?php echo THEMEPATH; ?>assets/img/microsoft-gold-partner.png" alt="Microsoft gold partner logo">
				</div>
