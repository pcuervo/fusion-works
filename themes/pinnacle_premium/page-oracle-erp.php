...
<section class="[ container ][ text-center ][ relative ]">
	<img class="[ hidden-xs hidden-sm ][ wow bounceInLeft ][ absolute left-0 ]" src="<?php echo THEMEPATH; ?>assets/img/oracle-tuercas1.png" alt="fondo tuercas">
	<img class="[ hidden-xs hidden-sm ][ wow bounceInRight ][ absolute right-0 ]" src="<?php echo THEMEPATH; ?>assets/img/oracle-tuercas2.png" alt="fondo tuercas">
...
<section class="[ background-primary--info ]">
	<div class="[ container ][ text-center ][ padding-top-bottom--large ]">
		<a class="[ btn-infografia ][ wow bounceInUp ]" href="/contact-us/">
