...
<div class="[ info-erp ][ margin-top--xlarge ]">
		...
		<article class="[ container ]">
			<div class="[ row ][ margin-bottom ]">
				<div data-wow-delay="1000ms" class="[ col-xs-12 ][ margin-bottom--xlarge ][ wow slideInRight ]">
					...
					<img class="[ wow rotateIn ][ img-responsive ][ absolute right-0 ]" src="<?php echo THEMEPATH; ?>assets/img/3-cogs.png">
				</div>
			</div>
			<div class="[ row ]">
				<div class="[ col-sm-8 ] margin-bottom ][ wow slideInrRight ]">
				...
				<div class="[ col-sm-7 col-sm-offset-2 ][ margin-bottom ][ wow slideInLeft ]">
				...
				<div class="[ col-sm-6 col-sm-offset-4  ][ margin-bottom ][ wow slideInRight ]">
				...
				<img class="[ wow rotateIn ][ pull-left ][ img-responsive ]" src="<?php echo THEMEPATH; ?>assets/img/3cogs.png">
				<div class="[ col-sm-6 ][ margin-bottom ][ pull-right ][ wow slideInLeft ]">
	...
	<section class="[ background-secondary-60 ][ padding--xlarge ]">
		<article class="[ container ]">
			<div class="[ row ]">
				<div data-wow-delay="1000ms" class="[ col-xs-12 ][ margin-bottom--xlarge ][ wow slideInLeft ]">
					<p class="[ text-large inline text-uppercase text-semi-bold ][ color-primary background-light-60 ][ padding ]">Our Qualifications</p>
				</div>
			</div>
			<div class="[ row ]">
				<div class="[ col-sm-4 ][ margin-bottom--xlarge ][ wow pulse ]">
